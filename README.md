# JwtWorkshop (: Security & Auth — JWT, OAuth2, Roles)

## Огляд
Практичне завдання №8 з дисципліни "Професійна практика програмної інженерії", яке включає реалізацію автентифікації (JWT) та авторизації (RBAC) на основі ролей за допомогою **C# (.NET 8) Minimal APIs**.
